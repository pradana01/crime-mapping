    ...
    <Container>
      ...
      <Content padder style={{ backgroundColor: "#f0f0f0" }}>
        ...
        <View style={{ width: '100%', backgroundColor: '#fff', borderRadius: 10, padding: 10, marginBottom: 10 }}>
          ...
          <View style={{ backgroundColor: '#E4F8EC', flexDirection: 'column', alignItems: 'flex-start', borderRadius: 10, padding: 15, marginBottom: 10, }}>
            <Text style={{ fontWeight: 'bold', color: '#01C04E', fontSize: 16, }}>DOs </Text>
          ...
          <View style={{ backgroundColor: '#FBE4E4', flexDirection: 'column', alignItems: 'flex-start', borderRadius: 10, padding: 15, }}>
            <Text style={{ fontWeight: 'bold', color: '#DF0000', fontSize: 16, }}>DONTs </Text>
        ...
        <View style={{ width: '100%', backgroundColor: '#fff', borderRadius: 10, padding: 10, marginBottom: 10 }}>
          ...
          <View style={{ backgroundColor: '#FBE4E4', flexDirection: 'column', alignItems: 'flex-start', padding: 15, borderRadius: 10, }}>
        ...
        <View style={{ width: '100%', backgroundColor: '#fff', borderRadius: 10, padding: 10, marginBottom: 10 }}>
          ...
          <View style={{ backgroundColor: '#E4F8EC', flexDirection: 'column', alignItems: 'flex-start', }}>
            <Text style={{ fontWeight: 'bold', color: '#01C04E', fontSize: 16, marginHorizontal: 10 }}>DOs </Text>
            <Text>- Learn basic self defence</Text>
            <Text>- Keep sober at all time</Text>
          </View>
          <View style={{ backgroundColor: '#FBE4E4', flexDirection: 'column', alignItems: 'flex-start', }}>
            <Text style={{ fontWeight: 'bold', color: '#DF0000', fontSize: 16, marginHorizontal: 10 }}>DONTs </Text>
